...
& TW,ZDR,ZER,ZUR,ZDL,ZEL,VSs,ZUL,UV,UVR,XU,XV,ZH,ZW,ZZ,alphaH,vvSM,vS,g1,g2,             & 
& g3,Lam,LS1H,LS,LS2H,LSP,LSPH,Yu,Yd,Ye,YRD,YRB1,YRB2,YRC,YRA1,YRA2,MDF,m2SM,            & 
& MS12,MS22,mP2,delta0,gMZ,kont)
...
Complex(dp) :: cplcFxeFxeVPL,cplcFxeFxeVPR,cplcFxeFxeVZL,cplcFxeFxeVZR,cplcFxeFxvcVWpL(2),           & 
...
MFd = sqrt(MFd2) 
MFu = sqrt(MFu2) 
alphaQ = AlphaEw_T(alphaEW_MS,mudim,MHp,MVWp,MFxe,MFd,MFu,MFe) 
...
CosW2SinW2=(1._dp-sinW2_Q)*sinW2_Q
If (IncludeDeltaVB) Then 
Call DeltaVB(sinW2,sinW2_Q,rho,MAh,MFe,MFv,MFxe,MFxv,Mhh,MHp,MSsc,ZER,ZEL,            & 
& VSs,UV,UVR,XU,XV,Ye,YRA1,YRA2,YRB1,YRB2,ZH,delta)
...
! Full one-loop corrections
Call CouplingsForSMfermions(Yd,ZDL,ZDR,ZH,g3,g1,g2,TW,Yu,ZUL,ZUR,Ye,ZEL,              & 
& ZER,UV,YRA1,YRA2,VSs,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,              & 
...
& cplcUFeFxecSscL,cplcUFeFxecSscR)

Call Sigma1LoopFeMZ(p2,MFe,MFe2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MHp,MHp2,MFv,              & 
...
Call ParametersToG83(g1,g2,g3,Lam,LS1H,LS,LS2H,LSP,LSPH,Yu,Yd,Ye,YRD,YRB1,            & 
& YRB2,YRC,YRA1,YRA2,MDF,m2SM,MS12,MS22,mP2,gMZ)
...
& MS22,mP2,mGut,kont,WriteComment,niter)
...
Real(dp) :: g_SM(62) 
Real(dp) :: delta0,deltaG0, gA(83), gB(83)
Real(dp) :: gC(85),  gD(85) 
Real(dp),Intent(out) :: mGUT
Complex(dp) :: Tad1Loop(2), lambda_SM, lambda_MZ 
Real(dp) :: comp(2), tanbQ, vev2 
Complex(dp) :: cplAhAhUhh(2),cplAhUhhVZ(2),cplcFdFdUhhL(3,3,2),cplcFdFdUhhR(3,3,2),cplcFeFeUhhL(3,3,2),& 
...
Real(dp) ::mass_new(21),mass_old(21),diff_m(21)
...
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+1) = MFxv
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+1) = MSsc
n_tot = n_tot + 2 
mass_old(n_tot:n_tot+0) = MFxe
n_tot = n_tot + 1 
...
If (kont.Ne.0) Then 
  ...
  Call TerminateProgram 
End If 
Call BoundaryBSM(j,g_SM,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MFxe,            & 
...
mGUT = 1._dp 
Call GToParameters83(gB,g1,g2,g3,Lam,LS1H,LS,LS2H,LSP,LSPH,Yu,Yd,Ye,YRD,              & 
...
Subroutine FirstGuess(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MFxe,              & 
& MFxe2,MFxv,MFxv2,Mhh,Mhh2,MHp,MHp2,MSsc,MSsc2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,              & 
& ZER,ZUR,ZDL,ZEL,VSs,ZUL,UV,UVR,XU,XV,ZH,ZW,ZZ,alphaH,vvSM,vS,g1,g2,g3,Lam,             & 
& LS1H,LS,LS2H,LSP,LSPH,Yu,Yd,Ye,YRD,YRB1,YRB2,YRC,YRA1,YRA2,MDF,m2SM,MS12,              & 
& MS22,mP2,kont)
...
Real(dp):: gA(83), gB(83), Scale_Save 
...
End Module Boundaries_SDdiracDM 
