...
Module FlavorKit_QFV_SDdiracDM 
Use Control 
Use Settings 
...
& MFe2,MFu,MFu2,MFv,MFv2,MFxe,MFxe2,Mhh,Mhh2,MHp,MHp2,MSsc,MSsc2,MVWp,MVWp2,             & 
...
& MFxe2,Mhh(2),Mhh2(2),MHp,MHp2,MSsc(2),MSsc2(2),MVWp,MVWp2,MVZ,MVZ2
...
& cplcFvFvVZR(3,3),cplcFxeFeSscL(3,2),cplcFxeFeSscR(3,2),cplcFxeFxeVPL,cplcFxeFxeVPR,    & 
& cplcFxeFxeVZL,cplcFxeFxeVZR,cplcHpVPVWp,cplcHpVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,         & 
& cplhhcHpVWp(2),cplhhcVWpVWp(2),cplhhhhhh(2,2,2),cplhhHpcHp(2),cplhhHpcVWp(2),          & 
& cplhhSsccSsc(2,2,2),cplhhVZVZ(2),cplHpcHpVP,cplHpcHpVZ,cplHpcVWpVP,cplHpcVWpVZ
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,MFxe,MFxe2,Mhh,Mhh2,MHp,MHp2,MSsc,MSsc2,MVWp,               & 
& MVWp2,MVZ,MVZ2,cplAhAhhh,cplAhcHpVWp,cplAhhhVZ,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,    & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,               & 
& cplcFdFucHpL,cplcFdFucHpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFeAhL,cplcFeFeAhR,         & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcFeFxecSscL,cplcFeFxecSscR,   & 
...
End if 
 ...
 ! Propagator: Ah, Loop particles: Ssc,Fxe, Internal fermion: bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxe).and.(Include_in_loopFe).and.IncludeWave) Then 
Do i1=1,2
    Do i3=1,3
If ((MSsc2(i1).gt.mf_l2(3)).Or.(MFxe2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFxeFeSscL(gt3,i1)
coup1R = cplcFxeFeSscR(gt3,i1)
...
End if 
 ...
 ! Propagator: Ah, Loop particles: Fxe,Ssc, Internal fermion: Fe
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopFxe).and.(Include_in_loopSsc).and.(Include_in_loopFe).and.IncludeWave) Then 
  Do i2=1,2
    Do i3=1,3
If ((MFxe2.gt.mf_l2(3)).Or.(MSsc2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplcFeFeAhL(i3,gt3)
coup3R = cplcFeFeAhR(i3,gt3)
coup2L = cplcFxeFeSscL(i3,i2)
coup2R = cplcFxeFeSscR(i3,i2)
coup1L = cplcFeFxecSscL(gt4,i2)
coup1R = cplcFeFxecSscR(gt4,i2)
coup4L = cplcFdFdAhL(gt2,gt1)
coup4R = cplcFdFdAhR(gt2,gt1)
! Masses in loop
mF1 = MFxe
...
End if 
 ...
 ! Propagator: hh, Loop particles: Ssc,Fxe, Internal fermion: bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxe).and.(Include_in_loopFe).and.IncludeWave) Then 
Do iProp=1,2
...
End if 
 ...
 ! Propagator: hh, Loop particles: Fxe,Ssc, Internal fermion: Fe
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopFxe).and.(Include_in_loopSsc).and.(Include_in_loopFe).and.IncludeWave) Then 
Do iProp=1,2
...
End if 
 ...
 ! Propagator: hh, Loop particles: bar[Fxe],conj[Ssc],conj[Ssc]
! Generic diagram: FSS,  InsertionOrder: 4
chargefactor = 1 
If ((Include_in_loopFxe).and.(Include_in_loopSsc).and.(Include_in_loopSsc).and.IncludePenguins) Then 
Do iProp=1,2
  Do i2=1,2
    Do i3=1,2
If ((MFxe2.gt.mf_l2(3)).Or.(MSsc2(i2).gt.mf_l2(3)).Or.(MSsc2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFxeFeSscL(gt3,i2)
coup1R = cplcFxeFeSscR(gt3,i2)
coup2L = cplcFeFxecSscL(gt4,i3)
coup2R = cplcFeFxecSscR(gt4,i3)
coup3 = cplhhSsccSsc(iProp,i3,i2)
coup4L = cplcFdFdhhL(gt2,gt1,iProp)
coup4R = cplcFdFdhhR(gt2,gt1,iProp)
! Masses in loop
mF1 = MFxe
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ssc,Fxe, Internal fermion: bar[Fe]
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxe).and.(Include_in_loopFe).and.IncludeWave) Then 
Do i1=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fxe,Ssc, Internal fermion: Fe
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopFxe).and.(Include_in_loopSsc).and.(Include_in_loopFe).and.IncludeWave) Then 
  Do i2=1,2
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ssc,Fxe,Fxe
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxe).and.(Include_in_loopFxe).and.IncludePenguins) Then 
Do i1=1,2
If ((MSsc2(i1).gt.mf_l2(3)).Or.(MFxe2.gt.mf_l2(3)).Or.(MFxe2.gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFxeFeSscL(gt3,i1)
coup1R = cplcFxeFeSscR(gt3,i1)
coup2L = cplcFeFxecSscL(gt4,i1)
coup2R = cplcFeFxecSscR(gt4,i1)
...
& cplcVWpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,BOddvvVRR,BOddvvVLL,BOddvvVRL,           & 
& BOddvvVLR)
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(3),MFv2(3),MFxv(2),         & 
& MFxv2(2),Mhh(2),Mhh2(2),MHp,MHp2,MSsc(2),MSsc2(2),MVWp,MVWp2,MVZ,MVZ2
...
& cplcFvFxvcSscL(3,2,2),cplcFvFxvcSscR(3,2,2),cplcFxvFvSscL(2,3,2),cplcFxvFvSscR(2,3,2), & 
& cplcFxvFxvVZL(2,2),cplcFxvFxvVZR(2,2),cplcHpVWpVZ,cplcVWpVWpVZ,cplhhVZVZ(2),           & 
...
& MFe,MFe2,MFu,MFu2,MFv,MFv2,MFxv,MFxv2,Mhh,Mhh2,MHp,MHp2,MSsc,MSsc2,MVWp,               & 
...
& cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplcFvFxvcSscL,cplcFvFxvcSscR,cplcFxvFvSscL,cplcFxvFvSscR,cplcFxvFxvVZL,               & 
& cplcFxvFxvVZR,cplcHpVWpVZ,cplcVWpVWpVZ,cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,               & 
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ssc,Fxv, Internal fermion: bar[Fv]
! Generic diagram: SFF,  InsertionOrder: 7
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxv).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
If ((MSsc2(i1).gt.mf_l2(3)).Or.(MFxv2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFxvFvSscL(i2,gt3,i1)
coup1R = cplcFxvFvSscR(i2,gt3,i1)
coup2L = cplcFvFxvcSscL(i3,i2,i1)
coup2R = cplcFvFxvcSscR(i3,i2,i1)
coup3L = cplcFvFvVZL(gt4,i3)
coup3R = cplcFvFvVZR(gt4,i3)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Fxv,Ssc, Internal fermion: Fv
! Generic diagram: FSF,  InsertionOrder: 8
chargefactor = 1 
If ((Include_in_loopFxv).and.(Include_in_loopSsc).and.(Include_in_loopFv).and.IncludeWave) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,3
If ((MFxv2(i1).gt.mf_l2(3)).Or.(MSsc2(i2).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup3L = cplcFvFvVZL(i3,gt3)
coup3R = cplcFvFvVZR(i3,gt3)
coup2L = cplcFxvFvSscL(i1,i3,i2)
coup2R = cplcFxvFvSscR(i1,i3,i2)
coup1L = cplcFvFxvcSscL(gt4,i1,i2)
coup1R = cplcFvFxvcSscR(gt4,i1,i2)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mF1 = MFxv(i1)
...
End if 
 ...
 ! Propagator: VZ, Loop particles: Ssc,Fxv,Fxv
! Generic diagram: SFF,  InsertionOrder: 4
chargefactor = 1 
If ((Include_in_loopSsc).and.(Include_in_loopFxv).and.(Include_in_loopFxv).and.IncludePenguins) Then 
Do i1=1,2
  Do i2=1,2
    Do i3=1,2
If ((MSsc2(i1).gt.mf_l2(3)).Or.(MFxv2(i2).gt.mf_l2(3)).Or.(MFxv2(i3).gt.mf_l2(3))) Then
If (.not.OnlySM) Then 
coup1L = cplcFxvFvSscL(i2,gt3,i1)
coup1R = cplcFxvFvSscR(i2,gt3,i1)
coup2L = cplcFvFxvcSscL(gt4,i3,i1)
coup2R = cplcFvFxvcSscR(gt4,i3,i1)
coup3L = cplcFxvFxvVZL(i3,i2)
coup3R = cplcFxvFxvVZR(i3,i2)
coup4L = cplcFdFdVZL(gt2,gt1)
coup4R = cplcFdFdVZR(gt2,gt1)
! Masses in loop
mS1 = MSsc(i1)
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MFd(3),MFd2(3),MFu(3),MFu2(3),Mhh(2),Mhh2(2),MHp,MHp2,MVWp,MVWp2,MVZ,MVZ2
...
& MSsc2,MVWp,MVWp2,MVZ,MVZ2,cplAhcHpVWp,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,             & 
...
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,cplcFeFvcVWpL,cplcFeFvcVWpR,         & 
& cplcFeFxecSscL,cplcFeFxecSscR,cplcFuFdHpL,cplcFuFdHpR,cplcFuFdVWpL,cplcFuFdVWpR,       & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFvFeHpL,cplcFvFeHpR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,             & 
& cplcFvFxvcSscL,cplcFvFxvcSscR,cplcFxeFeSscL,cplcFxeFeSscR,cplcFxeFxvcHpL,              & 
...
Implicit None 
Real(dp),Intent(in) :: MAh,MAh2,MFd(3),MFd2(3),MFe(3),MFe2(3),MFu(3),MFu2(3),MFv(3),MFv2(3),MFxe,            & 
& MFxe2,MFxv(2),MFxv2(2),Mhh(2),Mhh2(2),MHp,MHp2,MSsc(2),MSsc2(2),MVWp,MVWp2,MVZ,MVZ2

Complex(dp),Intent(in) :: cplAhcHpVWp,cplAhHpcVWp,cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFdFdhhL(3,3,2),         & 
& cplcFdFdhhR(3,3,2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),& 
...
& cplcFeFxecSscL(3,2),cplcFeFxecSscR(3,2),cplcFuFdHpL(3,3),cplcFuFdHpR(3,3),             & 
& cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuAhL(3,3),cplcFuFuAhR(3,3),cplcFuFuhhL(3,3,2),& 
& cplcFuFuhhR(3,3,2),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFvFeHpL(3,3),cplcFvFeHpR(3,3),& 
& cplcFvFeVWpL(3,3),cplcFvFeVWpR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFxvcSscL(3,2,2),& 
& cplcFvFxvcSscR(3,2,2),cplcFxeFeSscL(3,2),cplcFxeFeSscR(3,2),cplcFxeFxvcHpL(2),         & 
& cplcFxeFxvcHpR(2),cplcFxeFxvcVWpL(2),cplcFxeFxvcVWpR(2),cplcFxvFvSscL(2,3,2),          & 
& cplcFxvFvSscR(2,3,2),cplcHpVWpVZ,cplcVWpVWpVZ,cplhhcHpVWp(2),cplhhcVWpVWp(2),          & 
& cplhhHpcHp(2),cplhhHpcVWp(2),cplHpcHpVZ,cplHpcVWpVZ
...
& cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucHpL(3,3), & 
& cplcFdFucHpR(3,3),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),cplcFuFdHpL(3,3),              & 
& cplcFuFdHpR(3,3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),& 
& cplcHpVPVWp,cplcVWpVPVWp,cplHpcHpVP,cplHpcVWpVP
...
Complex(dp),Intent(in) :: cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFdFdhhL(3,3,2),cplcFdFdhhR(3,3,2),              & 
& cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucHpL(3,3), & 
& cplcFdFucHpR(3,3),cplcFdFucVWpL(3,3),cplcFdFucVWpR(3,3),cplcFuFdHpL(3,3),              & 
& cplcFuFdHpR(3,3),cplcFuFdVWpL(3,3),cplcFuFdVWpR(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3)
...
Complex(dp),Intent(in) :: cplAhAhhh(2),cplAhhhVZ(2),cplcFdFdAhL(3,3),cplcFdFdAhR(3,3),cplcFdFdhhL(3,3,2),       & 
& cplcFdFdhhR(3,3,2),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFucHpL(3,3),cplcFdFucHpR(3,3),& 
...
End Function C1C2 
End Module FlavorKit_QFV_SDdiracDM 
