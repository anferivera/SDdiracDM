...
Logical, Save :: CalcLoopDecay_Ssc=.True.
Logical, Save :: CalcLoopDecay_Fxe=.True.
Logical, Save :: CalcLoopDecay_Fxv=.True.
...
Complex(dp) :: UVROS_0(3, 3)
Complex(dp) :: UVROS_p2(3, 3)
Complex(dp) :: XVOS_0(2, 2)
Complex(dp) :: XVOS_p2(2, 2)
Complex(dp) :: XUOS_0(2, 2)
Complex(dp) :: XUOS_p2(2, 2)
Real(dp) :: VSsOS_0(2, 2)
Real(dp) :: VSsOS_p2(2, 2)
Real(dp) :: mP2Tree 
Real(dp) :: mP21L 
Real(dp) :: mP22L 
Real(dp) :: m2SMTree 
Real(dp) :: m2SM1L 
Real(dp) :: m2SM2L 
Real(dp) :: mass_uncertainty_Q(21), mass_uncertainty_Yt(21), g_SM_save(62) 
...
Real(dp) :: g1IN,g2IN,g3IN,LS1HIN,LSIN,LS2HIN,LSPIN,LSPHIN,YRDIN,YRB1IN(3),YRB2IN(3),             & 
& YRCIN,YRA1IN(3),YRA2IN(3),MDFIN,m2SMIN,MS12IN,MS22IN,mP2IN

Complex(dp) :: LamIN,YuIN(3,3),YdIN(3,3),YeIN(3,3)

Real(dp) :: g1MZ,g2MZ,g3MZ,LS1HMZ,LSMZ,LS2HMZ,LSPMZ,LSPHMZ,YRDMZ,YRB1MZ(3),YRB2MZ(3),             & 
& YRCMZ,YRA1MZ(3),YRA2MZ(3),MDFMZ,m2SMMZ,MS12MZ,MS22MZ,mP2MZ

Complex(dp) :: LamMZ,YuMZ(3,3),YdMZ(3,3),YeMZ(3,3)

Real(dp) :: g1GUT,g2GUT,g3GUT,LS1HGUT,LSGUT,LS2HGUT,LSPGUT,LSPHGUT,YRDGUT,YRB1GUT(3),             & 
& YRB2GUT(3),YRCGUT,YRA1GUT(3),YRA2GUT(3),MDFGUT,m2SMGUT,MS12GUT,MS22GUT,mP2GUT
...
Real(dp) :: vvSMFix,vSFix

Real(dp) :: gPFu(3,174),gTFu(3),BRFu(3,174),gPFe(3,173),gTFe(3),BRFe(3,173),gPFd(3,174),          & 
...
Real(dp) :: gP1LFu(3,18),gT1LFu(3),BR1LFu(3,18),gP1LFe(3,17),gT1LFe(3),BR1LFe(3,17),              & 
& gP1LFd(3,18),gT1LFd(3),BR1LFd(3,18),gP1Lhh(2,61),gT1Lhh(2),BR1Lhh(2,61),               & 
& gP1LSsc(2,17),gT1LSsc(2),BR1LSsc(2,17),gP1LFxe(1,12),gT1LFxe,BR1LFxe(1,12),            & 
& gP1LFxv(2,15),gT1LFxv(2),BR1LFxv(2,15)

Real(dp) :: ratioFd(2,3),ratioFe(2,3),ratioFu(2,3),ratioHp(2),ratioVWp(2)
...
Logical, save :: InputValueforLS1H =.False. 
Logical, save :: InputValueforLS =.False. 
Logical, save :: InputValueforLS2H =.False. 
Logical, save :: InputValueforLSP =.False. 
Logical, save :: InputValueforLSPH =.False. 
Logical, save :: InputValueforYu =.False. 
Logical, save :: InputValueforYd =.False. 
Logical, save :: InputValueforYe =.False. 
Logical, save :: InputValueforYRD =.False. 
Logical, save :: InputValueforYRB1 =.False. 
Logical, save :: InputValueforYRB2 =.False. 
Logical, save :: InputValueforYRC =.False. 
Logical, save :: InputValueforYRA1 =.False. 
Logical, save :: InputValueforYRA2 =.False. 
...
Logical, save :: InputValueformP2 =.False. 
...
Complex(dp) :: LambdaIN
Complex(dp) :: MDFInput
Complex(dp) :: MS12Input
Complex(dp) :: MS22Input
Complex(dp) :: LamS1HInput
Complex(dp) :: LamS2HInput
Complex(dp) :: LamSPHInput
Complex(dp) :: LamSInput
Complex(dp) :: LamSPInput
Complex(dp) :: vSInput
Complex(dp) :: YRDInput
Complex(dp) :: YRCInput
Real(dp) :: vvSMMZ 
...
MS12Input=(0._dp,0._dp) 
MS22Input=(0._dp,0._dp) 
LamS1HInput=(0._dp,0._dp) 
LamS2HInput=(0._dp,0._dp) 
LamSPHInput=(0._dp,0._dp) 
LamSInput=(0._dp,0._dp) 
LamSPInput=(0._dp,0._dp) 
vSInput=(0._dp,0._dp) 
YRDInput=(0._dp,0._dp) 
YRCInput=(0._dp,0._dp) 
End Subroutine Set_All_Parameters_0 
 


Subroutine SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vvSM,              & 
& vS,g1,g2,g3,Lam,LS1H,LS,LS2H,LSP,LSPH,Yu,Yd,Ye,YRD,YRB1,YRB2,YRC,YRA1,YRA2,            & 
& MDF,m2SM,MS12,MS22,mP2,MZsuffix)
...
End Module Model_Data_SDdiracDM