...
InputValueforYe= .True. 
   ...
   Else If (read_line(7:12).Eq."YRB1IN") Then 
InputValueforYRB1= .True. 
    Call ReadVectorR(99,3,YRB1IN, "YRB1IN",kont)

 
   Else If (read_line(7:12).Eq."YRB2IN") Then 
InputValueforYRB2= .True. 
    Call ReadVectorR(99,3,YRB2IN, "YRB2IN",kont)

 
   Else If (read_line(7:12).Eq."YRA1IN") Then 
InputValueforYRA1= .True. 
    Call ReadVectorR(99,3,YRA1IN, "YRA1IN",kont)

 
   Else If (read_line(7:12).Eq."YRA2IN") Then 
InputValueforYRA2= .True. 
    Call ReadVectorR(99,3,YRA2IN, "YRA2IN",kont)
   ...
   Else If (read_line(7:12).Eq."LS1HIN") Then 
    Call Read_LS1HIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMLS1HIN") Then 
    Call Read_LS1HIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:10).Eq."LSIN") Then 
    Call Read_LSIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMLSIN") Then 
    Call Read_LSIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."LS2HIN") Then 
    Call Read_LS2HIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMLS2HIN") Then 
    Call Read_LS2HIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."LSPIN") Then 
    Call Read_LSPIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMLSPIN") Then 
    Call Read_LSPIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."LSPHIN") Then 
    Call Read_LSPHIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMLSPHIN") Then 
    Call Read_LSPHIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."YRDIN") Then 
    Call Read_YRDIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMYRDIN") Then 
    Call Read_YRDIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."YRCIN") Then 
    Call Read_YRCIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMYRCIN") Then 
    Call Read_YRCIN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:12).Eq."MS12IN") Then 
    Call Read_MS12IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMMS12IN") Then 
    Call Read_MS12IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."MS22IN") Then 
    Call Read_MS22IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMMS22IN") Then 
    Call Read_MS22IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."MP2IN") Then 
    Call Read_MP2IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMMP2IN") Then 
    Call Read_MP2IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:10).Eq."VSIN") Then 
    Call Read_VSIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMVSIN") Then 
    Call Read_VSIN(99,1,i_model,set_mod_par,kont) 
...
If (i_c.Eq.0) MS12Input= Cmplx(wert,Aimag(MS12Input),dp) 
If (i_c.Eq.1) MS12Input= Cmplx(Real(MS12Input,dp),wert,dp) 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) MS22Input= Cmplx(wert,Aimag(MS22Input),dp) 
If (i_c.Eq.1) MS22Input= Cmplx(Real(MS22Input,dp),wert,dp) 
Else If (i_par.Eq.5) Then 
If (i_c.Eq.0) LamS1HInput= Cmplx(wert,Aimag(LamS1HInput),dp) 
If (i_c.Eq.1) LamS1HInput= Cmplx(Real(LamS1HInput,dp),wert,dp) 
Else If (i_par.Eq.6) Then 
If (i_c.Eq.0) LamS2HInput= Cmplx(wert,Aimag(LamS2HInput),dp) 
If (i_c.Eq.1) LamS2HInput= Cmplx(Real(LamS2HInput,dp),wert,dp) 
Else If (i_par.Eq.7) Then 
If (i_c.Eq.0) LamSPHInput= Cmplx(wert,Aimag(LamSPHInput),dp) 
If (i_c.Eq.1) LamSPHInput= Cmplx(Real(LamSPHInput,dp),wert,dp) 
Else If (i_par.Eq.8) Then 
If (i_c.Eq.0) LamSInput= Cmplx(wert,Aimag(LamSInput),dp) 
If (i_c.Eq.1) LamSInput= Cmplx(Real(LamSInput,dp),wert,dp) 
Else If (i_par.Eq.9) Then 
If (i_c.Eq.0) LamSPInput= Cmplx(wert,Aimag(LamSPInput),dp) 
If (i_c.Eq.1) LamSPInput= Cmplx(Real(LamSPInput,dp),wert,dp) 
...
If (i_c.Eq.0) YRDInput= Cmplx(wert,Aimag(YRDInput),dp) 
If (i_c.Eq.1) YRDInput= Cmplx(Real(YRDInput,dp),wert,dp) 
Else If (i_par.Eq.12) Then 
If (i_c.Eq.0) YRCInput= Cmplx(wert,Aimag(YRCInput),dp) 
If (i_c.Eq.1) YRCInput= Cmplx(Real(YRCInput,dp),wert,dp) 
Else
...
Case(1101) 
   If (wert.ne.1) Include_in_loopFxe= .False. 
Case(1102) 
...
Case(1106) 
   If (wert.ne.1) Include_in_loopFxv= .False. 
Case(1201) 
...
Case(1204) 
   If (wert.ne.1) Include_in_loopSsc= .False. 
Case(1301) 
...
Case(1005) 
  If (wert.ne.1) CalcLoopDecay_Ssc= .False. 
Case(1006) 
  If (wert.ne.1) CalcLoopDecay_Fxe= .False. 
Case(1007) 
  If (wert.ne.1) CalcLoopDecay_Fxv= .False. 
Case(1101) 
...
Complex(dp) :: PDGhh(2),PDGAh,PDGHp,PDGVP,PDGVZ,PDGVG,PDGVWp,PDGgP,PDGgWp,PDGgWpC,PDGgZ,             & 
& PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3),PDGSsc(2),PDGFxe,PDGFxv(2)
...
Character(len=30),Dimension(2):: NameParticleSsc
Character(len=30) :: NameParticleFxe
Character(len=30),Dimension(2):: NameParticleFxv
...
PDGSsc(1)=635
NameParticleSsc(1)="Ssc_1"
PDGSsc(2)=636
NameParticleSsc(2)="Ssc_2"
PDGFxe=210004
NameParticleFxe="Fxe"
PDGFxv(1)=210001
NameParticleFxv(1)="Fxv_1"
PDGFxv(2)=210002
NameParticleFxv(2)="Fxv_2"
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SDdiracDM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 3, Real(MS12Input,dp) ,"# MS12Input"
Write(io_L,101) 4, Real(MS22Input,dp) ,"# MS22Input"
Write(io_L,101) 5, Real(LamS1HInput,dp) ,"# LamS1HInput"
Write(io_L,101) 6, Real(LamS2HInput,dp) ,"# LamS2HInput"
Write(io_L,101) 7, Real(LamSPHInput,dp) ,"# LamSPHInput"
Write(io_L,101) 8, Real(LamSInput,dp) ,"# LamSInput"
Write(io_L,101) 9, Real(LamSPInput,dp) ,"# LamSPInput"
Write(io_L,101) 10, Real(vSInput,dp) ,"# vSInput"
Write(io_L,101) 11, Real(YRDInput,dp) ,"# YRDInput"
Write(io_L,101) 12, Real(YRCInput,dp) ,"# YRCInput"
WriteNextBlock = .False. 
If (Abs(Aimag(LambdaIN)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(MDFInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(MS12Input)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(MS22Input)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(LamS1HInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(LamS2HInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(LamSPHInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(LamSInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(LamSPInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(vSInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(YRDInput)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(YRCInput)).gt.0._dp) WriteNextBlock = .True. 
...
End if 
If (Abs(Aimag(MS12Input)).gt.0._dp) Then 
Write(io_L,101) 3, Aimag(MS12Input) ,"# MS12Input"
End if 
If (Abs(Aimag(MS22Input)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(MS22Input) ,"# MS22Input"
End if 
If (Abs(Aimag(LamS1HInput)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(LamS1HInput) ,"# LamS1HInput"
End if 
If (Abs(Aimag(LamS2HInput)).gt.0._dp) Then 
Write(io_L,101) 6, Aimag(LamS2HInput) ,"# LamS2HInput"
End if 
If (Abs(Aimag(LamSPHInput)).gt.0._dp) Then 
Write(io_L,101) 7, Aimag(LamSPHInput) ,"# LamSPHInput"
End if 
If (Abs(Aimag(LamSInput)).gt.0._dp) Then 
Write(io_L,101) 8, Aimag(LamSInput) ,"# LamSInput"
End if 
If (Abs(Aimag(LamSPInput)).gt.0._dp) Then 
Write(io_L,101) 9, Aimag(LamSPInput) ,"# LamSPInput"
End if 
If (Abs(Aimag(vSInput)).gt.0._dp) Then 
Write(io_L,101) 10, Aimag(vSInput) ,"# vSInput"
End if 
If (Abs(Aimag(YRDInput)).gt.0._dp) Then 
Write(io_L,101) 11, Aimag(YRDInput) ,"# YRDInput"
End if 
If (Abs(Aimag(YRCInput)).gt.0._dp) Then 
Write(io_L,101) 12, Aimag(YRCInput) ,"# YRCInput"
End if 
End if 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LS1H Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(LS1H,dp), "# LS1H" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(LS,dp), "# LS" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LS2H Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(LS2H,dp), "# LS2H" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LSP Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(LSP,dp), "# LSP" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LSPH Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(LSPH,dp), "# LSPH" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YRD Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(YRD,dp), "# YRD" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YRC Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(YRC,dp), "# YRC" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MS12 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(MS12,dp), "# MS12" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MS22 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(MS22,dp), "# MS22" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MP2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(mP2,dp), "# mP2" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block VS Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(vS,dp), "# vS" 
Write(io_L,104) 1,Real(vS,dp), "# vS" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TREEMP2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(mP2Tree,dp), "# mP2" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LOOPMP2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,Real(mP21L,dp), "# mP2" 
Else 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TREESM Q=",Q,"# (Renormalization Scale)" 
...
Write(io_L,106) "Block YRB1 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,YRB1(1), "# YRB1(1) " 
Write(io_L,104) 2,YRB1(2), "# YRB1(2) " 
Write(io_L,104) 3,YRB1(3), "# YRB1(3) " 
Write(io_L,106) "Block YRB2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,YRB2(1), "# YRB2(1) " 
Write(io_L,104) 2,YRB2(2), "# YRB2(2) " 
Write(io_L,104) 3,YRB2(3), "# YRB2(3) " 
Write(io_L,106) "Block YRA1 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,YRA1(1), "# YRA1(1) " 
Write(io_L,104) 2,YRA1(2), "# YRA1(2) " 
Write(io_L,104) 3,YRA1(3), "# YRA1(3) " 
Write(io_L,106) "Block YRA2 Q=",Q,"# (Renormalization Scale)" 
Write(io_L,104) 1,YRA2(1), "# YRA2(1) " 
Write(io_L,104) 2,YRA2(2), "# YRA2(2) " 
Write(io_L,104) 3,YRA2(3), "# YRA2(3) " 
...
Write(io_L,106) "Block LS1HGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(LS1HGUT,dp), "# LS1H" 
Write(io_L,106) "Block LSGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(LSGUT,dp), "# LS" 
Write(io_L,106) "Block LS2HGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(LS2HGUT,dp), "# LS2H" 
Write(io_L,106) "Block LSPGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(LSPGUT,dp), "# LSP" 
Write(io_L,106) "Block LSPHGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(LSPHGUT,dp), "# LSPH" 
Write(io_L,106) "Block YRDGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(YRDGUT,dp), "# YRD" 
Write(io_L,106) "Block YRCGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(YRCGUT,dp), "# YRC" 
Write(io_L,106) "Block MDFGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(MDFGUT,dp), "# MDF" 
Write(io_L,106) "Block MS12GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(MS12GUT,dp), "# MS12" 
Write(io_L,106) "Block MS22GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(MS22GUT,dp), "# MS22" 
Write(io_L,106) "Block MP2GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(mP2GUT,dp), "# mP2" 
...
Write(io_L,106) "Block YRB1GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,YRB1GUT(1), "# YRB1GUT(1) " 
Write(io_L,104) 2,YRB1GUT(2), "# YRB1GUT(2) " 
Write(io_L,104) 3,YRB1GUT(3), "# YRB1GUT(3) " 
Write(io_L,106) "Block YRB2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,YRB2GUT(1), "# YRB2GUT(1) " 
Write(io_L,104) 2,YRB2GUT(2), "# YRB2GUT(2) " 
Write(io_L,104) 3,YRB2GUT(3), "# YRB2GUT(3) " 
Write(io_L,106) "Block YRA1GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,YRA1GUT(1), "# YRA1GUT(1) " 
Write(io_L,104) 2,YRA1GUT(2), "# YRA1GUT(2) " 
Write(io_L,104) 3,YRA1GUT(3), "# YRA1GUT(3) " 
Write(io_L,106) "Block YRA2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,YRA2GUT(1), "# YRA2GUT(1) " 
Write(io_L,104) 2,YRA2GUT(2), "# YRA2GUT(2) " 
Write(io_L,104) 3,YRA2GUT(3), "# YRA2GUT(3) " 
End if 
...
If (OutputForMG)  Write(io_L,102) 21,0.,"# VG" 
 ...
 Write(io_L,102) INT(Abs(PDGSsc(1))),MSsc(1),"# "//Trim(NameParticleSsc(1))// "" 
If (MassLSP(1).gt.Abs(MSsc(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 635 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSsc(1))
Else 
If (MassLSP(2).gt.Abs(MSsc(1))) Then 
PDGLSP(2) = 635 
MassLSP(2) = Abs(MSsc(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSsc(2))),MSsc(2),"# "//Trim(NameParticleSsc(2))// "" 
If (MassLSP(1).gt.Abs(MSsc(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 636 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSsc(2))
Else 
If (MassLSP(2).gt.Abs(MSsc(2))) Then 
PDGLSP(2) = 636 
MassLSP(2) = Abs(MSsc(2))
End if 
End if 
 Write(io_L,102) 210004,MFxe,"# Fxe" 
If (MassLSP(1).gt.Abs(MFxe)) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210004 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFxe)
Else 
If (MassLSP(2).gt.Abs(MFxe)) Then 
PDGLSP(2) = 210004 
MassLSP(2) = Abs(MFxe)
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFxv(1))),MFxv(1),"# "//Trim(NameParticleFxv(1))// "" 
If (MassLSP(1).gt.Abs(MFxv(1))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210001 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFxv(1))
Else 
If (MassLSP(2).gt.Abs(MFxv(1))) Then 
PDGLSP(2) = 210001 
MassLSP(2) = Abs(MFxv(1))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGFxv(2))),MFxv(2),"# "//Trim(NameParticleFxv(2))// "" 
If (MassLSP(1).gt.Abs(MFxv(2))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 210002 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MFxv(2))
Else 
If (MassLSP(2).gt.Abs(MFxv(2))) Then 
PDGLSP(2) = 210002 
MassLSP(2) = Abs(MFxv(2))
End if 
End if 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(210001)), Sqrt(mass_uncertainty_Q(3)**2+mass_uncertainty_Yt(3)**2),"# MFxv(1) " 
 Write(io_L,102) INT(Abs(210002)), Sqrt(mass_uncertainty_Q(4)**2+mass_uncertainty_Yt(4)**2),"# MFxv(2) " 
 Write(io_L,102) INT(Abs(635)), Sqrt(mass_uncertainty_Q(5)**2+mass_uncertainty_Yt(5)**2),"# MSsc(1) " 
 Write(io_L,102) INT(Abs(636)), Sqrt(mass_uncertainty_Q(6)**2+mass_uncertainty_Yt(6)**2),"# MSsc(2) " 
 Write(io_L,102) INT(Abs(210004)), Sqrt(mass_uncertainty_Q(7)**2+mass_uncertainty_Yt(7)**2),"# MFxe(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(210001)), mass_uncertainty_Q(3),"# MFxv(1) " 
 Write(io_L,102) INT(Abs(210002)), mass_uncertainty_Q(4),"# MFxv(2) " 
 Write(io_L,102) INT(Abs(635)), mass_uncertainty_Q(5),"# MSsc(1) " 
 Write(io_L,102) INT(Abs(636)), mass_uncertainty_Q(6),"# MSsc(2) " 
 Write(io_L,102) INT(Abs(210004)), mass_uncertainty_Q(7),"# MFxe(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(210001)), mass_uncertainty_Yt(3),"# MFxv(1) " 
 Write(io_L,102) INT(Abs(210002)), mass_uncertainty_Yt(4),"# MFxv(2) " 
 Write(io_L,102) INT(Abs(635)), mass_uncertainty_Yt(5),"# MSsc(1) " 
 Write(io_L,102) INT(Abs(636)), mass_uncertainty_Yt(6),"# MSsc(2) " 
 Write(io_L,102) INT(Abs(210004)), mass_uncertainty_Yt(7),"# MFxe(1) " 
End if
...
Write(io_L,106) "Block UVRMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(UVR(1,1),dp), "# Real(UVR(1,1),dp)" 
Write(io_L,107)1,2,Real(UVR(1,2),dp), "# Real(UVR(1,2),dp)" 
Write(io_L,107)1,3,Real(UVR(1,3),dp), "# Real(UVR(1,3),dp)" 
Write(io_L,107)2,1,Real(UVR(2,1),dp), "# Real(UVR(2,1),dp)" 
Write(io_L,107)2,2,Real(UVR(2,2),dp), "# Real(UVR(2,2),dp)" 
Write(io_L,107)2,3,Real(UVR(2,3),dp), "# Real(UVR(2,3),dp)" 
Write(io_L,107)3,1,Real(UVR(3,1),dp), "# Real(UVR(3,1),dp)" 
Write(io_L,107)3,2,Real(UVR(3,2),dp), "# Real(UVR(3,2),dp)" 
Write(io_L,107)3,3,Real(UVR(3,3),dp), "# Real(UVR(3,3),dp)" 
If ((MaxVal(Abs(AImag(UVR))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMUVRMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(UVR(1,1)), "# Aimag(UVR(1,1))" 
Write(io_L,107)1,2,Aimag(UVR(1,2)), "# Aimag(UVR(1,2))" 
Write(io_L,107)1,3,Aimag(UVR(1,3)), "# Aimag(UVR(1,3))" 
Write(io_L,107)2,1,Aimag(UVR(2,1)), "# Aimag(UVR(2,1))" 
Write(io_L,107)2,2,Aimag(UVR(2,2)), "# Aimag(UVR(2,2))" 
Write(io_L,107)2,3,Aimag(UVR(2,3)), "# Aimag(UVR(2,3))" 
Write(io_L,107)3,1,Aimag(UVR(3,1)), "# Aimag(UVR(3,1))" 
Write(io_L,107)3,2,Aimag(UVR(3,2)), "# Aimag(UVR(3,2))" 
Write(io_L,107)3,3,Aimag(UVR(3,3)), "# Aimag(UVR(3,3))" 
End If 

Write(io_L,106) "Block XV Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(XV(1,1),dp), "# Real(XV(1,1),dp)" 
Write(io_L,107)1,2,Real(XV(1,2),dp), "# Real(XV(1,2),dp)" 
Write(io_L,107)2,1,Real(XV(2,1),dp), "# Real(XV(2,1),dp)" 
Write(io_L,107)2,2,Real(XV(2,2),dp), "# Real(XV(2,2),dp)" 
If ((MaxVal(Abs(AImag(XV))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMXV Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(XV(1,1)), "# Aimag(XV(1,1))" 
Write(io_L,107)1,2,Aimag(XV(1,2)), "# Aimag(XV(1,2))" 
Write(io_L,107)2,1,Aimag(XV(2,1)), "# Aimag(XV(2,1))" 
Write(io_L,107)2,2,Aimag(XV(2,2)), "# Aimag(XV(2,2))" 
End If 

Write(io_L,106) "Block XU Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(XU(1,1),dp), "# Real(XU(1,1),dp)" 
Write(io_L,107)1,2,Real(XU(1,2),dp), "# Real(XU(1,2),dp)" 
Write(io_L,107)2,1,Real(XU(2,1),dp), "# Real(XU(2,1),dp)" 
Write(io_L,107)2,2,Real(XU(2,2),dp), "# Real(XU(2,2),dp)" 
If ((MaxVal(Abs(AImag(XU))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMXU Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(XU(1,1)), "# Aimag(XU(1,1))" 
Write(io_L,107)1,2,Aimag(XU(1,2)), "# Aimag(XU(1,2))" 
Write(io_L,107)2,1,Aimag(XU(2,1)), "# Aimag(XU(2,1))" 
Write(io_L,107)2,2,Aimag(XU(2,2)), "# Aimag(XU(2,2))" 
End If 

Write(io_L,106) "Block VSs Q=",Q,"# ()" 
Write(io_L,107)1,1,VSs(1,1), "# VSs(1,1)" 
Write(io_L,107)1,2,VSs(1,2), "# VSs(1,2)" 
Write(io_L,107)2,1,VSs(2,1), "# VSs(2,1)" 
Write(io_L,107)2,2,VSs(2,2), "# VSs(2,2)" 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(1,19:174)).Gt.BRmin) Then 
...
If (BRFu(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFd(gt1) 
CurrentPDG3(2) = -PDGFxe 
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRFu(1,icount).Gt.BrMin) Then 
CurrentPDG3(1) = PDGFu(gt1) 
CurrentPDG3(2) = -PDGFxv(gt2) 
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(1) = PDGFu(gt1) 
CurrentPDG3(2) = -PDGFxe 
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFu(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(2,19:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFu(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  End Do 
If (Maxval(BRFu(3,19:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFu(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFu(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
icount = icount +1 
  ...
  Do gt2=1, 2
If (BRFe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFxe 
CurrentPDG2(2) = -PDGSsc(gt2) 
Write(io_L,201) BRFe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleSsc(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(1,18:173)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSsc(gt2) 
Write(io_L,201) BRFe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleSsc(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(2,18:173)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGSsc(gt2) 
Write(io_L,201) BRFe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleSsc(gt2))//"^* "//")"
End if 
icount = icount +1 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFe(3,18:173)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFe(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFe(3))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(1,19:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(1))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(2,19:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(2))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
icount = icount +1 
  End Do 
If (Maxval(BRFd(3,19:174)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG3(3) = PDGFxv(gt3) 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFd(gt1))//" "//Trim(NameParticleFxe)//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1=1,3
...
CurrentPDG3(3) = PDGFxe 
Write(io_L,202) BRFd(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleFd(3))//" -> "//Trim(NameParticleFu(gt1))//" "//Trim(NameParticleFxv(gt2))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1= 1, 2
  Do gt2=1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFxv(gt1) 
CurrentPDG2(2) = PDGFxv(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleFxv(gt1))//"^* "//Trim(NameParticleFxv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Do gt1= 1, 2
  Do gt2=1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGSsc(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleSsc(gt1))//"^* "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (BRhh(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFxe 
CurrentPDG2(2) = -PDGFxe 
Write(io_L,201) BRhh(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(1))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleFxe)//"^* "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRhh(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = PDGFxv(gt2) 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleFxv(gt1))//"^* "//Trim(NameParticleFxv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleSsc(gt1))//"^* "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGFxe 
Write(io_L,201) BRhh(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(2))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleFxe)//"^* "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRhh(2,icount).Gt.BrMin) Then 
...
If ((gTSsc(1).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGSsc(1)),gTSsc(1),Trim(NameParticleSsc(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRSsc(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFe(gt1) 
CurrentPDG2(2) = PDGFxe 
Write(io_L,201) BRSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGFxv(gt2) 
Write(io_L,201) BRSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleFv(gt1))//"^* "//Trim(NameParticleFxv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
If ((gTSsc(2).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGSsc(2)),gTSsc(2),Trim(NameParticleSsc(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BRSsc(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFe(gt1) 
CurrentPDG2(2) = PDGFxe 
Write(io_L,201) BRSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = PDGFxv(gt2) 
Write(io_L,201) BRSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleFv(gt1))//"^* "//Trim(NameParticleFxv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleSsc(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If ((gTFxe.gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGFxe),gTFxe,Trim(NameParticleFxe) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRFxe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BRFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
If (BRFxe(1,icount).Gt.BrMin) Then 
...
CurrentPDG2(2) = -PDGVWp 
Write(io_L,201) BRFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticleVWp)//"^* "//")"
End if 
icount = icount +1 
  End Do 
  Do gt2=1, 2
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
End Do 
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
End if 
...
If ((gTFxv(1).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGFxv(1)),gTFxv(1),Trim(NameParticleFxv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRFxv(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BRFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
  Do gt2=1, 2
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
If ((gTFxv(2).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGFxv(2)),gTFxv(2),Trim(NameParticleFxv(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BRFxv(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BRFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVWp 
Write(io_L,201) BRFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFxe)//" "//Trim(NameParticleVWp)//" "//")"
End if 
icount = icount +1 
Do gt1= 1, 2
  Do gt2=1, 2
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 2
...
CurrentPDG2(2) = PDGVP 
Write(io_L,201) BRFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFxv(gt1))//" "//Trim(NameParticleVP)//" "//")"
End if 
icount = icount +1 
  End Do 
End if 
...
If(gT1LSsc(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSsc(1)),gT1LSsc(1),Trim(NameParticleSsc(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BR1LSsc(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFe(gt1) 
CurrentPDG2(2) = PDGFxe 
Write(io_L,201) BR1LSsc(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(1))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LSsc(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGSsc(2)),gT1LSsc(2),Trim(NameParticleSsc(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
If (BR1LSsc(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = -PDGFe(gt1) 
CurrentPDG2(2) = PDGFxe 
Write(io_L,201) BR1LSsc(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSsc(2))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleFxe)//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LFxe.gt.MinWidth) Then 
Write(io_L,210) INT(PDGFxe),gT1LFxe,Trim(NameParticleFxe) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BR1LFxe(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFe(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BR1LFxe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxe)//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
If(gT1LFxv(1).gt.MinWidth) Then 
Write(io_L,210) INT(PDGFxv(1)),gT1LFxv(1),Trim(NameParticleFxv(1)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BR1LFxv(1,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BR1LFxv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(1))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
icount = icount +1 
  End Do 
End if 
If(gT1LFxv(2).gt.MinWidth) Then 
Write(io_L,210) INT(PDGFxv(2)),gT1LFxv(2),Trim(NameParticleFxv(2)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 3
  Do gt2=1, 2
If (BR1LFxv(2,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGFv(gt1) 
CurrentPDG2(2) = PDGSsc(gt2) 
Write(io_L,201) BR1LFxv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleFxv(2))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSsc(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SDdiracDM",status="unknown")
...
Write(123,*) "LSPH= ",LSPH
Write(123,*) "YRD= ",YRD
Write(123,*) "YRB11= ",YRB1(1)
Write(123,*) "YRB12= ",YRB1(2)
Write(123,*) "YRB13= ",YRB1(3)
Write(123,*) "YRB21= ",YRB2(1)
Write(123,*) "YRB22= ",YRB2(2)
Write(123,*) "YRB23= ",YRB2(3)
Write(123,*) "YRC= ",YRC
Write(123,*) "YRA11= ",YRA1(1)
Write(123,*) "YRA12= ",YRA1(2)
Write(123,*) "YRA13= ",YRA1(3)
Write(123,*) "YRA21= ",YRA2(1)
Write(123,*) "YRA22= ",YRA2(2)
Write(123,*) "YRA23= ",YRA2(3)
Write(123,*) "vS= ",vS
Write(123,*) "vS= ",vS
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "MSsc1= ", Abs(MSsc(1)) 
Write(123,*) "MSsc2= ", Abs(MSsc(2)) 
Write(123,*) "MCha= ", Abs(MFxe) 
Write(123,*) "MChi01= ", Abs(MFxv(1)) 
Write(123,*) "MChi02= ", Abs(MFxv(2)) 
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "WCha = ",gTFxe
Write(123,*) "WChi01 = ",gTFxv(1)
Write(123,*) "WChi02 = ",gTFxv(2)
Write(123,*) "" 
Write(123,*) "" 
...
Write(123,*) "" 
If (MFxv(1).Gt.0._dp) Then 
Write(123,*) "XV11_r = ", Real(XV(1,1),dp)
Write(123,*) "XV11_i = ", AImag(XV(1,1))
Write(123,*) "XV12_r = ", Real(XV(1,2),dp)
Write(123,*) "XV12_i = ", AImag(XV(1,2))
Else 
Write(123,*) "XV11_i = ", Real(XV(1,1),dp)
Write(123,*) "XV11_r = ", -AImag(XV(1,1))
Write(123,*) "XV12_i = ", Real(XV(1,2),dp)
Write(123,*) "XV12_r = ", -AImag(XV(1,2))
End if 
If (MFxv(2).Gt.0._dp) Then 
Write(123,*) "XV21_r = ", Real(XV(2,1),dp)
Write(123,*) "XV21_i = ", AImag(XV(2,1))
Write(123,*) "XV22_r = ", Real(XV(2,2),dp)
Write(123,*) "XV22_i = ", AImag(XV(2,2))
Else 
Write(123,*) "XV21_i = ", Real(XV(2,1),dp)
Write(123,*) "XV21_r = ", -AImag(XV(2,1))
Write(123,*) "XV22_i = ", Real(XV(2,2),dp)
Write(123,*) "XV22_r = ", -AImag(XV(2,2))
End if 
If (MFxv(1).Gt.0._dp) Then 
Write(123,*) "XU11_r = ", Real(XU(1,1),dp)
Write(123,*) "XU11_i = ", AImag(XU(1,1))
Write(123,*) "XU12_r = ", Real(XU(1,2),dp)
Write(123,*) "XU12_i = ", AImag(XU(1,2))
Else 
Write(123,*) "XU11_i = ", Real(XU(1,1),dp)
Write(123,*) "XU11_r = ", -AImag(XU(1,1))
Write(123,*) "XU12_i = ", Real(XU(1,2),dp)
Write(123,*) "XU12_r = ", -AImag(XU(1,2))
End if 
If (MFxv(2).Gt.0._dp) Then 
Write(123,*) "XU21_r = ", Real(XU(2,1),dp)
Write(123,*) "XU21_i = ", AImag(XU(2,1))
Write(123,*) "XU22_r = ", Real(XU(2,2),dp)
Write(123,*) "XU22_i = ", AImag(XU(2,2))
Else 
Write(123,*) "XU21_i = ", Real(XU(2,1),dp)
Write(123,*) "XU21_r = ", -AImag(XU(2,1))
Write(123,*) "XU22_i = ", Real(XU(2,2),dp)
Write(123,*) "XU22_r = ", -AImag(XU(2,2))
End if 
Write(123,*) "VSs11= ",VSs(1,1)
Write(123,*) "VSs12= ",VSs(1,2)
Write(123,*) "VSs21= ",VSs(2,1)
Write(123,*) "VSs22= ",VSs(2,2)
...
Write(123,*) "UVR11_r = ", Real(UVR(1,1),dp)
Write(123,*) "UVR11_i = ", AImag(UVR(1,1))
Write(123,*) "UVR12_r = ", Real(UVR(1,2),dp)
Write(123,*) "UVR12_i = ", AImag(UVR(1,2))
Write(123,*) "UVR13_r = ", Real(UVR(1,3),dp)
Write(123,*) "UVR13_i = ", AImag(UVR(1,3))
Write(123,*) "UVR21_r = ", Real(UVR(2,1),dp)
Write(123,*) "UVR21_i = ", AImag(UVR(2,1))
Write(123,*) "UVR22_r = ", Real(UVR(2,2),dp)
Write(123,*) "UVR22_i = ", AImag(UVR(2,2))
Write(123,*) "UVR23_r = ", Real(UVR(2,3),dp)
Write(123,*) "UVR23_i = ", AImag(UVR(2,3))
Write(123,*) "UVR31_r = ", Real(UVR(3,1),dp)
Write(123,*) "UVR31_i = ", AImag(UVR(3,1))
Write(123,*) "UVR32_r = ", Real(UVR(3,2),dp)
Write(123,*) "UVR32_i = ", AImag(UVR(3,2))
Write(123,*) "UVR33_r = ", Real(UVR(3,3),dp)
Write(123,*) "UVR33_i = ", AImag(UVR(3,3))
    Close(123) 
...
Subroutine WriteWCXF 
   Open(123,file="WC.SDdiracDM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.SDdiracDM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
Subroutine Read_LS1HIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
LS1HIN= wert 
InputValueforLS1H= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block LS1HIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMLS1HIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block LS1HIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMLS1HIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_LS1HIN 
 
 
Subroutine Read_LSIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block LSIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMLSIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block LSIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMLSIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_LSIN 
 
 
Subroutine Read_LS2HIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
LS2HIN= wert 
InputValueforLS2H= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block LS2HIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMLS2HIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block LS2HIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMLS2HIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_LS2HIN 
 
 
Subroutine Read_LSPIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
LSPIN= wert 
InputValueforLSP= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block LSPIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMLSPIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block LSPIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMLSPIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_LSPIN 
 
 
Subroutine Read_LSPHIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
LSPHIN= wert 
InputValueforLSPH= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block LSPHIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMLSPHIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block LSPHIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMLSPHIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_LSPHIN 
 
 
Subroutine Read_YRDIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
YRDIN= wert 
InputValueforYRD= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YRDIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYRDIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YRDIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYRDIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YRDIN 
 
 
Subroutine Read_YRCIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
YRCIN= wert 
InputValueforYRC= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YRCIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYRCIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YRCIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYRCIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YRCIN 
...
Subroutine Read_MS12IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
MS12IN= wert 
InputValueforMS12= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MS12IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMS12IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MS12IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMS12IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MS12IN 
 
 
Subroutine Read_MS22IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
MS22IN= wert 
InputValueforMS22= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MS22IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMS22IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MS22IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMS22IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MS22IN 
 
 
Subroutine Read_MP2IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
mP2IN= wert 
InputValueformP2= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MP2IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMP2IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MP2IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMP2IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MP2IN 
 
 
Subroutine Read_VSIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block VSIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMVSIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block VSIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMVSIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_VSIN 
...
End Module InputOutput_SDdiracDM 
