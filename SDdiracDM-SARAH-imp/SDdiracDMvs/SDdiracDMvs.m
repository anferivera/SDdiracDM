...
Model`NameLaTeX ="Singlet doublet Dirac dark matter simplified";
Model`Authors = "Andres Rivera. Base in SM by F.Staub";
Model`Date = "2018-11-22";
...
Lagsinglet = - ( Mn2 nr1.nl1 + Mn3 nr2.nl2  );

Lagdoublet =  - ( MDF rd.ru  + YRD1 nr2.rd.H  + YRD2 conj[H].nl2.ru );
...
Lagint = -( YRC nr2.nl1.SP + YRC nl2.nr1.SP + YNU vr.l.H + YRA1 S1.l.ru + YRA2 S2.l.ru + YRB1 nl1.vr.S1 + YRB2 nl1.vr.S2 );
